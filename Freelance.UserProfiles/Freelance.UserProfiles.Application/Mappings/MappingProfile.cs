    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<FreelancerProfile, FreelancerProfileDto>()
                ...
                .ForMember(dest => dest.ForeignLanguages, opt => opt.MapFrom(src => src.ForeignLanguages.Select(l => l.Language)))
                .ForMember(dest => dest.ProgrammingLanguages, opt => opt.MapFrom(src => src.Skills.Select(s => s.ProgrammingLanguage)))
            ...
            CreateMap<FreelancerProfileDto, FreelancerProfile>()
                ...
                .AfterMap((dto, entity) =>
                {
                    ...
                    if (dto.ProgrammingLanguages != null && dto.Areas != null)
                    {
                        ...
                        {
                            skills.Add(Skill.Create(dto.ProgrammingLanguages[i], dto.Areas[i]));
                        }
