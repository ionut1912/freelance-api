...
public class FreelancerProfileService : IFreelancerProfileRepository
{
    ...
    public async Task UpdateFreelancerProfileAsync(FreelancerProfile freelancerProfile,
        CancellationToken cancellationToken)
    {
    ...
    public async Task UpdateFreelancerProfileDetails(FreelancerProfile freelancerProfile, List<Skill> skills,
        CancellationToken cancellationToken)
    {
    ...
    public async Task DeleteFreelancerProfileAsync(FreelancerProfile freelancerProfile,
        CancellationToken cancellationToken)
    {
