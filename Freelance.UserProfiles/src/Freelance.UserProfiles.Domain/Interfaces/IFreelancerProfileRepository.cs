...
{
    Task CreateFreelancerProfileAsync(FreelancerProfile createFreelancerProfileRequest,
        CancellationToken cancellationToken);

    Task UpdateFreelancerProfileAsync(FreelancerProfile freelancerProfile, CancellationToken cancellationToken);

    Task UpdateFreelancerProfileDetails(FreelancerProfile freelancerProfile, List<Skill> skills,
        CancellationToken cancellationToken);
