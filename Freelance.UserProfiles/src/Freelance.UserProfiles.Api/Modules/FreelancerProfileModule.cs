...
public static class FreelancerProfileModule
{
    public static void AddFreelancerProfileEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        freelancerOnlyGroup.MapPut("/details/{id:guid}",
            async (IMediator mediator, Guid id, [FromBody] UpdateFreelancerDetailRequest updateFreelancerDetailRequest,
        ...
        freelancerOnlyGroup.MapPut("/address/{id:guid}",
            async (IMediator mediator, Guid id, [FromBody] UpdateProfileAddressRequest updateProfileAddressRequest,
                CancellationToken ct) =>
            {
        ...
        freelancerOnlyGroup.MapPut("/data/{id:guid}",
            async (IMediator mediator, Guid id, [FromBody] UpdateProfileDataRequest updateProfileDataRequest,
                CancellationToken ct) =>
            {
        ...
        clientOnlyGroup.MapPut("/rating/{id:guid}",
            async (IMediator mediator, Guid id,
                [FromBody] UpdateFreelancerProfileRatingRequest updateFreelancerProfileRatingRequest,
                CancellationToken ct) =>
            {
