...
public class AccountRepository:IAccountRepository
{
    ...
    public AccountRepository(ApplicationDbContext dbContext,IPasswordService passwordService,IUnitOfWork<ApplicationDbContext> unitOfWork)
    {
    ...
    public async Task<Account> LoginAsync(string username, string password)
    {
        ...
        return !_passwordService.VerifyPassword(password, account.Password) ? throw new PasswordNotMatchException("Passwords do not match") : account;
    }
