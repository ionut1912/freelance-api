...
namespace Freelance.Infrastructure.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Projects_FreelancerProfiles_FreelancerId",
            ...
            migrationBuilder.InsertData(
                table: "Skills",
                columns: new[] { "Id", "Area", "CreatedAt", "ProgrammingLanguage", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, "Backend", new DateTime(2025, 9, 30, 14, 51, 51, 189, DateTimeKind.Utc).AddTicks(1357), ".NET", null },
                    { 2, "Frontend", new DateTime(2025, 9, 30, 14, 51, 51, 189, DateTimeKind.Utc).AddTicks(1361), "Angular", null },
                    { 3, "Frontend", new DateTime(2025, 9, 30, 14, 51, 51, 189, DateTimeKind.Utc).AddTicks(1362), "JavaScript", null },
                    { 4, "Frontend", new DateTime(2025, 9, 30, 14, 51, 51, 189, DateTimeKind.Utc).AddTicks(1363), "React", null },
                    { 5, "Backend", new DateTime(2025, 9, 30, 14, 51, 51, 189, DateTimeKind.Utc).AddTicks(1365), "Python", null },
                    { 6, "Backend", new DateTime(2025, 9, 30, 14, 51, 51, 189, DateTimeKind.Utc).AddTicks(1366), "Java", null }
                });
