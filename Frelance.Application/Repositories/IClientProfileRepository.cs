...
public interface IClientProfileRepository
{
    ...
    Task<ClientProfileDto> GetClientProfileByIdAsync(GetClientProfileByIdQuery clientProfileByIdQuery,
        CancellationToken cancellationToken);

    Task<ClientProfileDto?> GetLoggedInClientProfileAsync(GetLoggedInClientProfileQuery loggedInClientProfileQuery,
        CancellationToken cancellationToken);

    Task<PaginatedList<ClientProfileDto>> GetClientProfilesAsync(GetClientProfilesQuery clientProfilesQuery,
        CancellationToken cancellationToken);
