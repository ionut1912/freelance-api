...
namespace Frelance.Infrastructure.Migrations
{
    ...
    [Migration("20250930134037_UpdateConfiguration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Frelance.Infrastructure.Entities.FreelancerProfileSkill", b =>
                {
                    b.Property<int>("FreelancerProfileId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Frelance.Infrastructure.Entities.Skills", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Area = "Backend",
                            CreatedAt = new DateTime(2025, 9, 30, 13, 40, 36, 221, DateTimeKind.Utc).AddTicks(2969),
                        ...
                        new
                        {
                            Id = 2,
                            Area = "Frontend",
                            CreatedAt = new DateTime(2025, 9, 30, 13, 40, 36, 221, DateTimeKind.Utc).AddTicks(2973),
                        ...
                        new
                        {
                            Id = 3,
                            Area = "Frontend",
                            CreatedAt = new DateTime(2025, 9, 30, 13, 40, 36, 221, DateTimeKind.Utc).AddTicks(2975),
                        ...
                        new
                        {
                            Id = 4,
                            Area = "Frontend",
                            CreatedAt = new DateTime(2025, 9, 30, 13, 40, 36, 221, DateTimeKind.Utc).AddTicks(2976),
                        ...
                        new
                        {
                            Id = 5,
                            Area = "Backend",
                            CreatedAt = new DateTime(2025, 9, 30, 13, 40, 36, 221, DateTimeKind.Utc).AddTicks(2979),
                        ...
                        new
                        {
                            Id = 6,
                            Area = "Backend",
                            CreatedAt = new DateTime(2025, 9, 30, 13, 40, 36, 221, DateTimeKind.Utc).AddTicks(2981),
            ...
            modelBuilder.Entity("Frelance.Infrastructure.Entities.FreelancerProfileSkill", b =>
                {
                    ...
                    b.HasOne("Frelance.Infrastructure.Entities.Skills", "Skill")
                        .WithMany("FreelancerProfileSkills")
            ...
            modelBuilder.Entity("Frelance.Infrastructure.Entities.Projects", b =>
                {
                    b.HasOne("Frelance.Infrastructure.Entities.ClientProfiles", "ClientProfiles")
                        .WithMany("Projects")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
